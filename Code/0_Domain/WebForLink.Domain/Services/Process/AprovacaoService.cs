...
{
    public class AprovacaoWebForLinkService : IAprovacaoWebForLinkService
    {
        private readonly IFornecedorBancoWebForLinkRepository _bancoFornecedorRepository;
        private readonly IFornecedorContatoWebForLinkRepository _contatoFornecedorRepository;
        private readonly IContratanteFornecedorWebForLinkRepository _contratanteFornecedor;
        private readonly IFornecedorDocumentoWebForLinkRepository _documentoFornecedorRepository;
        private readonly IFornecedorEnderecoWebForLinkRepository _enderecoFornecedorRepository;
        ...
        private readonly IFornecedorUnspscWebForLinkRepository _unspscFornecedorRepository;

        public AprovacaoWebForLinkService(
            ...
            IFornecedorEnderecoWebForLinkRepository enderecoFornecedor,
            IFornecedorContatoWebForLinkRepository contatoFornecedor,
            IFornecedorDocumentoWebForLinkRepository documentoFornecedor,
            IFornecedorUnspscWebForLinkRepository unspscFornecedor,
            ...
            )
        {
            try
            {
                ...
                _enderecoFornecedorRepository = enderecoFornecedor;
                _contatoFornecedorRepository = contatoFornecedor;
                _documentoFornecedorRepository = documentoFornecedor;
                _unspscFornecedorRepository = unspscFornecedor;
        ...
        {
            var solicitacao = _solicitacaoRepository.BuscarSolicitacaoFinalizaCriacaoFornecedor(solicitacaoId);
            ...
            var roboFornecedor = _roboRepository.Find(x => x.SOLICITACAO_ID == solicitacao.ID).FirstOrDefault();
            ...
            foreach (var solicitacaoModificacaoBanco in solicitacao.SolicitacaoModificacaoDadosBancario)
            {
                ...
                _bancoFornecedorRepository.Add(fornecedorBanco);
            ...
            foreach (var solicitacaoModificacaoEndereco in solicitacao.WFD_SOL_MOD_ENDERECO)
            {
                ...
                _enderecoFornecedorRepository.Add(fornecedorEndereco);
            ...
            foreach (var item in solicitacao.SolicitacaoModificacaoDadosContato)
            {
                ...
                _contatoFornecedorRepository.Add(contato);
            ...
            if (solicitacaoCadastroFornecedor.PJPF_TIPO != 2)
            {
                foreach (var item in solicitacao.SolicitacaoDeDocumentos)
                {
                    if (item.ARQUIVO_ID != null)
                    {
                        ...
                        _documentoFornecedorRepository.Add(documento);
            ...
            foreach (var item in solicitacao.WFD_SOL_UNSPSC)
            {
                ...
                _unspscFornecedorRepository.Add(unspsc);
            ...
            foreach (var item in solicitacao.WFD_INFORM_COMPL)
            {
                ...
                _informacaoComplementarFornecedorRepository.Add(infoCompl);
        ...
        public void FinalizarExpansao(int solicitacaoId)
        {
            ...
            foreach (var item in solicitacao.SolicitacaoModificacaoDadosBancario)
            {
                ...
                if (item.BANCO_PJPF_ID != null)
                {
                    ...
                    _bancoFornecedorRepository.Add(banco);
        ...
        public void FinalizarModificacaoDadosBancarios(int solicitacaoId)
        {
            ...
            foreach (var item in bancos)
            {
                if (solBancos.All(s => s.BANCO_PJPF_ID != item.ID))
                {
                    ...
                    _bancoFornecedorRepository.Delete(item);
                }
            }
        ...
        public void FinalizarModificacaoDadosEnderecos(int solicitacaoId)
        {
            ...
            foreach (var item in Enderecos)
            {
                if (solEnderecos.All(s => s.PJPF_ID != item.ID))
                {
                    ...
                    _enderecoFornecedorRepository.Delete(item);
                }
            }
            ...
            foreach (var item in solEnderecos)
            {
                if (item.PJPF_ENDERECO_ID == null)
                {
                    ...
                    _enderecoFornecedorRepository.Add(endereco);
                ...
                else
                {
                    ...
                    _enderecoFornecedorRepository.Update(endereco);
        ...
        public void FinalizarModificacaoDadosContatos(int solicitacaoId)
        {
            ...
            foreach (var item in contatos)
            {
                if (solContatos.All(s => s.CONTATO_PJPF_ID != item.ID))
                {
                    ...
                    _contatoFornecedorRepository.Delete(item);
                }
            }
            ...
            foreach (var item in solContatos)
            {
                ...
                else
                {
                    ...
                    contato.TELEFONE = Mascara.RemoverMascaraTelefone(item.TELEFONE);
                    contato.CELULAR = item.CELULAR;
                    _contatoFornecedorRepository.Update(contato);
        ...
        private void BloquearOuDesbloquear(int solicitacaoId, int? grupoId, int status)
        {
            ...
            {
                var contrForn = _contratanteFornecedor.Find(f => f.PJPF_ID == solicitacao.PJPF_ID
