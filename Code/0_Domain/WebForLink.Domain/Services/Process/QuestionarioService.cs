...
{
    public class QuestionarioService : Service<QUESTIONARIO>
    {
        ...
        public QuestionarioService(IQuestionarioWebForLinkRepository questionario,
            IInformacaoComplementarWebForLinkService resposta) : base(questionario)
        {
            try
            {
        ...
        public QUESTIONARIO BuscarPorId(int id)
        {
            try
            {
                return _questionarioRepository.Get(id);
            }
            catch (Exception ex)
            {
        ...
        public QUESTIONARIO BuscarPorIdEIdContratante(int id, int idContratante)
        {
            try
            {
                return _questionarioRepository.BuscarPorIdEIdContratante(id, idContratante);
            }
            catch (Exception ex)
            {
        ...
        public List<QUESTIONARIO> ListarTodos()
        {
            try
            {
                return _questionarioRepository.All().ToList();
            }
            catch (Exception ex)
            {
                throw new ServiceWebForLinkException("Erro ao buscar uma Lista de Perguntas por aba", ex);
