...
{
    public interface IFornecedorCategoriaWebForLinkService : IService<FORNECEDOR_CATEGORIA>
    {
        ...
        RetornoPesquisa<FORNECEDOR_CATEGORIA> PesquisarCategorias(
            Expression<Func<FORNECEDOR_CATEGORIA, bool>> predicate, int tamanhoPagina, int pagina);
    ...
    public class FornecedorCategoriaWebForLinkService : Service<FORNECEDOR_CATEGORIA>,
        IFornecedorCategoriaWebForLinkService
    {
        ...
        private readonly IFornecedorCategoriaWebForLinkRepository _categoriaFornecedorRepository;

        public FornecedorCategoriaWebForLinkService(
            IFornecedorCategoriaWebForLinkRepository fornecedorCategoriaRepository)
            : base(fornecedorCategoriaRepository)
        {
            try
            {
                _categoriaFornecedorRepository = fornecedorCategoriaRepository;
            }
            catch (Exception ex)
            {
        ...
        public FORNECEDOR_CATEGORIA BuscarPorId(int id)
        {
            try
            {
                return _categoriaFornecedorRepository.Get(id);
            }
            catch (Exception ex)
            {
        ...
        public FORNECEDOR_CATEGORIA Buscar(Expression<Func<FORNECEDOR_CATEGORIA, bool>> filtro)
        {
            try
            {
                return _categoriaFornecedorRepository.Find(filtro).FirstOrDefault();
            }
            catch (Exception ex)
            {
        ...
        public FORNECEDOR_CATEGORIA BuscarPorId(int id, int contratanteId)
        {
            ...
            {
                return
                    _categoriaFornecedorRepository.Find(c => c.CONTRATANTE_ID == contratanteId && c.ID == id)
                        .FirstOrDefault();
            }
            catch (Exception ex)
            {
        ...
        public FORNECEDOR_CATEGORIA InserirCategoria(FORNECEDOR_CATEGORIA categoria)
        {
            ...
            try
            {
                _categoriaFornecedorRepository.Add(categoria);
                return categoria;
            }
            catch (Exception ex)
            {
        ...
        public bool verificaDuplicidadeCodigo(int Id, string Codigo, int Contratante)
        {
            ...
            {
                return
                    _categoriaFornecedorRepository.Find(
        ...
        public FORNECEDOR_CATEGORIA AlterarCategoria(FORNECEDOR_CATEGORIA categoria)
        {
            //using (_unitOfWork)
            //{
            //FORNECEDOR_CATEGORIA novo = _categoriaFornecedorRepository.Get(categoria.ID);
            //if (novo == null)
            ...
            try
            {
                ...
                //    _categoriaFornecedorRepository.Update(novo);
                //}
                _categoriaFornecedorRepository.Update(categoria);
                return categoria;
            }
            catch (Exception ex)
            {
        ...
        public FORNECEDOR_CATEGORIA ExcluirCategoria(FORNECEDOR_CATEGORIA categoria)
        {
            ...
            try
            {
                _categoriaFornecedorRepository.Delete(categoria);
                return categoria;
            }
            catch (Exception ex)
            {
        ...
        public FORNECEDOR_CATEGORIA ExcluirCategoriaDireto(FORNECEDOR_CATEGORIA categoria)
        {
            ...
            try
            {
                _categoriaFornecedorRepository.Delete(
                    _categoriaFornecedorRepository.Find(x => x.ID == categoria.ID).FirstOrDefault());
                return categoria;
            }
            catch (Exception ex)
            {
        ...
        public FORNECEDOR_CATEGORIA BuscarPorCodigoContratanteId(string codigo, int contratanteId)
        {
            try
            {
                return _categoriaFornecedorRepository.Get(x => x.CODIGO == codigo && x.CONTRATANTE_ID == contratanteId);
            }
            catch (Exception ex)
            {
        ...
        public FORNECEDOR_CATEGORIA BuscarEmSolicitacaoFornecedor(int idContratante, int idCategoria)
        {
            try
            {
                return _categoriaFornecedorRepository.Get(c => c.CONTRATANTE_ID == idContratante && c.ID == idCategoria);
            }
            catch (Exception ex)
            {
        ...
        public List<FORNECEDOR_CATEGORIA> ListarTodosPorIdContratanteAtivo(int idContratante)
        {
            try
            {
                return _categoriaFornecedorRepository.Find(c => c.CONTRATANTE_ID == idContratante && c.ATIVO).ToList();
            }
            catch (Exception ex)
            {
                throw new ServiceWebForLinkException("Erro ao buscar uma lista de Categorias por Contratante", ex);
        ...
        public List<FORNECEDOR_CATEGORIA> BuscarPorCategoriaPai(int id, int contratanteId)
        {
            try
            {
                return
                    _categoriaFornecedorRepository.Find(
                        x => x.CATEGORIA_PAI_ID == id && x.CONTRATANTE_ID == contratanteId).ToList();
            }
            catch (Exception ex)
            {
        ...
        public RetornoPesquisa<FORNECEDOR_CATEGORIA> PesquisarCategorias(
            Expression<Func<FORNECEDOR_CATEGORIA, bool>> predicate, int tamanhoPagina, int pagina)
        {
            try
            {
                return _categoriaFornecedorRepository.Pesquisar(predicate, tamanhoPagina, pagina, x => x.ID);
            }
            catch (Exception ex)
            {
