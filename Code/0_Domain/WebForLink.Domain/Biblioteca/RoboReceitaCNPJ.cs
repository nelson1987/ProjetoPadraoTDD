...
namespace WebForDocs.Biblioteca
{
    public class RoboReceitaCNPJ
    {
        ...
        public void GravaRoboReceita(RoboReceitaCNPJ roboReceita, ref WFD_PJPF_ROBO robo)
        {
            try
            {
        ...
        private void MontaRobo(RoboReceitaCNPJ roboReceita, WFD_PJPF_ROBO robo)
        {
            if (roboReceita != null)
            {
        ...
        public RoboReceitaCNPJ MontaRoboView(WFD_PJPF_ROBO robo)
        {
