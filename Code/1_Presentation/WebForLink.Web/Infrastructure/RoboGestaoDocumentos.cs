...
namespace WebForLink.Web.Infrastructure
{
    ...
    public class RoboGestaoDocumentos
    {
        ...
        private static WebForLinkContexto db = new WebForLinkContexto();
        ...
        #region Predicativos
        private static Expression<Func<DocumentosDoFornecedor, bool>> predicativos(Expression<Func<DocumentosDoFornecedor, bool>> predicate)
        {
