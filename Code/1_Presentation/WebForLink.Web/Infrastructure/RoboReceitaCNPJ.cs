...
namespace WebForLink.Web.Infrastructure
{
    public class RoboReceitaCNPJ
    {
        ...
        public static RoboReceitaCNPJ ModelToViewModel(ROBO robo)
        {
        ...
        private void MontaCssMessagem()
        {
            if (Code == 1)
            {
                cssCor = (Data.SituacaoCadastral.ToUpper() == "ATIVA" ? "success" : "danger");
