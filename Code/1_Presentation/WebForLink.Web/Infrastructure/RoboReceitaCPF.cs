...
namespace WebForLink.Web.Infrastructure
{
    public class RoboReceitaCPF
    {
        ...
        public void GravaRoboCpf(RoboReceitaCPF roboReceitaCpf, ref ROBO robo)
        {
            try
            {
        ...
        public static RoboReceitaCPF ModelToViewModel(ROBO robo)
        {
            ...
            if (robo != null)
            {
                ...
                roboReceitaCpf.MontaCssMessagem();
