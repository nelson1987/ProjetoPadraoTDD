...
{
    public class DadosContatoModel : DemandaSapModel
    {
        public DadosContatoModel() { }
        public DadosContatoModel(string codigoSolicitacao, string empresa, string codigoSAP, string organizacaoCompras
