...
{
    public class FornecedorModel : DemandaSapModel
    {
        ...
        public FornecedorModel(string codigoSolicitacao, string empresa, string grupoContas, string organizacaoCompras, string simplesNacional
