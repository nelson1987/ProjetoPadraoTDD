...
{
    public class DadosBancariosCargaModel : DemandaSapModel
    {
        public DadosBancariosCargaModel() { }
        /// <summary>
        /// Dados bancarios
        /// </summary>
        ...
        public DadosBancariosCargaModel(string codigoSolicitacao, string empresa, string codigoSap
            ...
            , string banco5, string agencia5, string codigoAgencia5, string contaCorrente5, string dVContaCorrente5)
        {
            ...
            this.CodigoAgencia = codigoAgencia1;
            this.ContaCorrente = contaCorrente1;
            this.DVContaCorrente = dVContaCorrente1;
            this.Banco2 = banco2;
