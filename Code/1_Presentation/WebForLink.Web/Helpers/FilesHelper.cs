...
namespace WebForLink.Web.Helpers
{
    ...
    {
        private List<string> ExtensaoArquivoPermitido
        {
            get
            {
                return new List<string> {".pdf",".jpg", ".jpeg",".png", ".bmp", ".tiff", ".xls", ".xlsx", ".doc", ".docx", ".csv", ".txt", ".gif" };
            }
        }
        ...
        public bool UploadAndShowResults(HttpContextBase ContentBase, List<ViewDataUploadFilesResult> resultList)
        {
            ...
            foreach (String inputTagName in httpRequest.Files)
            {
                ...
                if (!ValidarExtensaoDeArquivo(extensao))
                    return false;
        ...
        private bool ValidarExtensaoDeArquivo(string extensao)
        {
            return ExtensaoArquivoPermitido.Any(x => extensao.Contains(x));
        }
        ...
        private void UploadWholeFile(HttpContextBase requestContext, List<ViewDataUploadFilesResult> statuses)
        {
            ...
            for (var i = 0; i < request.Files.Count; i++)
            {
                ...
                {
                    var extansion = imageArray[imageArray.Length - 1];
                    ...
                    else
                    {
                        ...
                        var fileThumb = file.FileName + ".80x80.jpg";
