...
{
    public class CadastroUnicoWebForLinkAppService : AppService<WebForLinkContexto>, ICadastroUnicoWebForLinkAppService
    {
        ...
        public CadastroUnicoWebForLinkAppService(IFornecedorWebForLinkService fornecedor,
            IQuestionarioWebForLinkService questionario, IInformacaoComplementarWebForLinkService informacaoComplementar)
        {
            try
            {
        ...
        public Fornecedor CarregarDadosPjpf(int idFornecedor)
        {
            try
            {
                return _fornecedorService.CarregarDadosPjpf(idFornecedor);
            }
            catch (Exception ex)
            {
        ...
        public List<QUESTIONARIO> BuscarPorIdContratanteParaIncluirSolicitacao(int idContratante, int idPapel)
        {
            ...
            foreach (var questionario in _questionarioService.Find(x => x.CONTRATANTE_ID == idContratante))
            {
        ...
        public Fornecedor CarregarDadosPjpf(int idFornecedor, int idPapel, int? idSolicitacao)
        {
            try
            {
                ...
                var questionariosContratante = _questionarioService.Find(x => x.CONTRATANTE_ID == 1).ToList();
        ...
        public List<QuestionarioDinamico> BuscarQuestionarioDinamico(QuestionarioDinamicoFiltrosDTO filtros)
        {
            ...
            foreach (var questionario in _questionarioService.Find(x => x.CONTRATANTE_ID == filtros.ContratanteId))
            {
                        ...
                        if (perguntaPapelFornecedor != null)
                        {
                                ...
                                //Se estiver em qualquer parte dos fluxos olhar INFORM_COMPL atrelado a sua solicitacao
                            {
                                ...
                                if (pergunta.PERG_PAI != null)
                                {
                                    ...
                                    {
                                        var respostaPaiGravada = _informacaoComplementarService
